...
### 1.2. pass > the `init` name is incorrect - the point of `init` is to apply the `action` from the first param
...
### 1.5. you can rewrite `lambda`-defined functions in python for explicity
